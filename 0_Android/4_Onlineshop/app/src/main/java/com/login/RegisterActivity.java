...
public class RegisterActivity extends Activity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener, Spinner.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new DBHelper(RegisterActivity.this, "user_db", null, 1);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.birth:
                ...
                break;
            case R.id.reg_btn:
                new AlertDialog.Builder(RegisterActivity.this).setTitle("系统提示")
                        .setMessage("是否确定提交？")
