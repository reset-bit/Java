...
class ShoppingCartAdapter extends BaseAdapter {
    ...
    private int[] pics={R.drawable.wydt_0,R.drawable.mg_0,R.drawable.xajsgc_0,R.drawable.tlcfybj_0,R.drawable.lxzb_0,R.drawable.sfdl_0,
            R.drawable.python_0,R.drawable.xwz_0,R.drawable.lbqdgcb_0,R.drawable.wsm_0,R.drawable.zyf_0,R.drawable.zgf_0,R.drawable.dmwc_0,
            R.drawable.wc_0,R.drawable.pn_0,R.drawable.rjgb_0,R.drawable.shldgs_0,R.drawable.smbb_0,R.drawable.njtzhk_0,R.drawable.lm_0,
            R.drawable.wzjlhax_0,R.drawable.mztkn_0,R.drawable.wdxlmtkcydh_0,R.drawable.wbswmxh_0,R.drawable.xynmsns_0,R.drawable.rulssyqm_0,
            R.drawable.mysql_0,R.drawable.linux_0,R.drawable.sql_0,R.drawable.sdxx_0,R.drawable.headfirstjava_0,R.drawable.cxy_0};
    public ShoppingCartAdapter(Context context, List<HashMap<String, String>> list) {
